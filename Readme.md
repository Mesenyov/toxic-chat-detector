# 🛡️ Russian Toxic Chat Detector (Детектор токсичности сообщений)
...
Кастомный пайплайн очистки текста (`src/text_cleaner.py`), который делает модель защищенной от пользователей, пытающихся обойти бан.
...
*   **Перевод омоглифов:** Заменяет английские буквы, визуально похожие на русские, обратно на кириллицу.
